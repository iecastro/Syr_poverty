...
poverty_city_chart <- rbind(p2011, p2012, p2013, p2014, p2015, p2016, p2017) %>%
  filter(year == 2017) %>%
  mutate(poverty_rate = round((B17001_002E/B17001_001E)*100)) %>%
  ggplot(aes(reorder(NAME, poverty_rate), poverty_rate, group = 1)) +
  geom_col() +
  coord_flip() + 
  ylim(c(0,100)) +
...
poverty_pub_trans_chart <- rbind(t2017,t2016,t2015,t2014,t2013,t2012,t2011) %>%
  ...
  geom_line() +
  ylim(c(0,100)) +
  scale_color_manual(labels = c("Percentage of people in poverty who take public transportation", "Percent of population that takes public transportation"), values = c("blue", "red")) +
...
city_transport <- t2017 %>%
  ...
  filter(!is.na(number)) %>%
  ggplot(aes(NAME, number, fill = percent_pub_transport)) +
  geom_col(position = "dodge") +
  coord_flip() +
  scale_fill_manual(labels = c("Percentage of people in poverty who take public transportation", "Percent of population that takes public transportation"), values = c("blue", "red")) +
  labs(title = "Percent of people riding public transportation",
       color = "Legend",
       x = "City",
       y = "Percentage")
